...
export const SwaggerListSavedViews = () =>
  applyDecorators(ApiOkResponse({ type: SavedViewEntity, isArray: true }));
...
export const SwaggerUpdateSavedView = () =>
  applyDecorators(
    ...
    ApiForbiddenResponse({
      description: 'Only the owner can modify this view',
    }),
  );
...
export const SwaggerDeleteSavedView = () =>
  applyDecorators(
    ...
    ApiNotFoundResponse({ description: 'Saved view not found' }),
    ApiForbiddenResponse({
      description: 'Only the owner can delete this view',
    }),
  );
